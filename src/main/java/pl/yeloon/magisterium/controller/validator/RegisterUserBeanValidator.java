...
public class RegisterUserBeanValidator implements Validator {
	...
	private static final String INVALID_NICKNAME = "web.register.validation.nickname.invalid";
	private static final String EMPTY_OR_WHITESPACE_NICKNAME = "web.register.validation.nickname.required";
	...
	public void validate(Object target, Errors errors) {
		...
		ValidationUtils.rejectIfEmptyOrWhitespace(errors, "nickname", EMPTY_OR_WHITESPACE_NICKNAME);
		...
		if(!rub.getNickname().matches("[a-zA-Z0-9\\- _]{4,}")){
			errors.rejectValue("nickname", INVALID_NICKNAME);
		}
