...
public class KodbotParser extends Parser {
	...
	public static class MainContext extends ParserRuleContext {
		...
		public TerminalNode MAIN() { return getToken(KodbotParser.MAIN, 0); }
	...
	public static class FunctionDefContext extends ParserRuleContext {
		public TerminalNode ID() { return getToken(KodbotParser.ID, 0); }
		public BlockContext block() {
			return getRuleContext(BlockContext.class,0);
		}
	...
	public static class BlockContext extends ParserRuleContext {
		public TerminalNode R_BRACKET() { return getToken(KodbotParser.R_BRACKET, 0); }
		public StatContext stat() {
			return getRuleContext(StatContext.class,0);
		}
		public TerminalNode L_BRACKET() { return getToken(KodbotParser.L_BRACKET, 0); }
	...
	public final BlockContext block() throws RecognitionException {
		...
		try {
			enterOuterAlt(_localctx, 1);
			{
			setState(48); match(L_BRACKET);
			setState(49); stat();
			setState(50); match(R_BRACKET);
			}
		}
		catch (RecognitionException re) {
			_localctx.exception = re;
	...
	public static class ExprContext extends ParserRuleContext {
		...
		public TerminalNode SEMICOLON() { return getToken(KodbotParser.SEMICOLON, 0); }
	...
	public final ExprContext expr() throws RecognitionException {
		...
		try {
			...
			case 3:
				{
				setState(60); turnLeft();
				}
				break;

			case 4:
				{
				setState(61); turnRight();
				}
				break;
			...
			case 7:
				{
				setState(64); assignWithAddition();
				}
				break;

			case 8:
				{
				setState(65); assignWithSubtraction();
				}
				break;

			case 9:
				{
				setState(66); increment();
				}
				break;

			case 10:
				{
				setState(67); decrement();
				}
				break;
			}
	...
	public static class RepeatContext extends ParserRuleContext {
		public TerminalNode REPEAT() { return getToken(KodbotParser.REPEAT, 0); }
		public TerminalNode L_PARENTHESIS() { return getToken(KodbotParser.L_PARENTHESIS, 0); }
		public BlockContext block() {
			return getRuleContext(BlockContext.class,0);
		}
		...
		public TerminalNode R_PARENTHESIS() { return getToken(KodbotParser.R_PARENTHESIS, 0); }
	...
	public final RepeatContext repeat() throws RecognitionException {
		...
		try {
			enterOuterAlt(_localctx, 1);
			{
			setState(72); match(REPEAT);
			setState(73); match(L_PARENTHESIS);
			setState(74); var();
			setState(75); match(R_PARENTHESIS);
			setState(76); block();
			}
		}
		catch (RecognitionException re) {
	...
	public static class VarContext extends ParserRuleContext {
		public TerminalNode ID() { return getToken(KodbotParser.ID, 0); }
		public TerminalNode NUMBER() { return getToken(KodbotParser.NUMBER, 0); }
	...
	public static class AssignWithAdditionContext extends ParserRuleContext {
		...
		public TerminalNode ID() { return getToken(KodbotParser.ID, 0); }
		public TerminalNode PLUS() { return getToken(KodbotParser.PLUS, 0); }
		public TerminalNode EQUAL() { return getToken(KodbotParser.EQUAL, 0); }
		...
		@Override public int getRuleIndex() { return RULE_assignWithAddition; }
		@Override
		public void enterRule(ParseTreeListener listener) {
	...
	public final AssignWithAdditionContext assignWithAddition() throws RecognitionException {
		...
		try {
			...
			setState(84); ((AssignWithAdditionContext)_localctx).firstRight = var();
			setState(85); match(PLUS);
			setState(86); ((AssignWithAdditionContext)_localctx).secondRight = var();
			}
		}
		catch (RecognitionException re) {
			_localctx.exception = re;
	...
	public static class AssignWithSubtractionContext extends ParserRuleContext {
		...
		public TerminalNode MINUS() { return getToken(KodbotParser.MINUS, 0); }
		public TerminalNode ID() { return getToken(KodbotParser.ID, 0); }
		public TerminalNode EQUAL() { return getToken(KodbotParser.EQUAL, 0); }
		public List<VarContext> var() {
			return getRuleContexts(VarContext.class);
		...
		@Override public int getRuleIndex() { return RULE_assignWithSubtraction; }
		@Override
		public void enterRule(ParseTreeListener listener) {
	...
	public final AssignWithSubtractionContext assignWithSubtraction() throws RecognitionException {
		...
		try {
			...
			setState(90); ((AssignWithSubtractionContext)_localctx).firstRight = var();
			setState(91); match(MINUS);
			setState(92); ((AssignWithSubtractionContext)_localctx).secondRight = var();
			}
		}
		catch (RecognitionException re) {
			_localctx.exception = re;
	...
	public static class MoveContext extends ParserRuleContext {
		public TerminalNode MOVE() { return getToken(KodbotParser.MOVE, 0); }
	...
	public static class JumpContext extends ParserRuleContext {
		public TerminalNode JUMP() { return getToken(KodbotParser.JUMP, 0); }
	...
	public static class TurnLeftContext extends ParserRuleContext {
		public TerminalNode TURN_LEFT() { return getToken(KodbotParser.TURN_LEFT, 0); }
	...
	public static class TurnRightContext extends ParserRuleContext {
		public TerminalNode TURN_RIGHT() { return getToken(KodbotParser.TURN_RIGHT, 0); }
	...
	public static class IncrementContext extends ParserRuleContext {
		public TerminalNode INCREMENT_ID() { return getToken(KodbotParser.INCREMENT_ID, 0); }
	...
	public final IncrementContext increment() throws RecognitionException {
		...
		try {
			enterOuterAlt(_localctx, 1);
			{
			setState(106); match(INCREMENT_ID);
			}
		}
		catch (RecognitionException re) {
			_localctx.exception = re;
	...
	public static class DecrementContext extends ParserRuleContext {
		public TerminalNode DECREMENT_ID() { return getToken(KodbotParser.DECREMENT_ID, 0); }
	...
	public final DecrementContext decrement() throws RecognitionException {
		...
		try {
			enterOuterAlt(_localctx, 1);
			{
			setState(108); match(DECREMENT_ID);
			}
		}
		catch (RecognitionException re) {
			_localctx.exception = re;
