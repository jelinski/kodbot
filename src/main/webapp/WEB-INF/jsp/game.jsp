...
<body>
	...
	<div id="main-div">
		<div id="game-div" class="container-div">
			...
			<div id="game-overlay">
				<em class="fa fa-cog fa-5x"></em> <span id="command-counter">1</span>
			</div>
			...
			<div id="score-container">
				...
				<h4 id="score-new" style="text-align: center">
                    ...
                    <em class="fa fa-cog"></em><span id="score-command-new" style="margin-right:10px"></span>
                    <em class="fa fa-bolt"></em><span id="score-battery-new"></span>
				</h4>
		...
		<div id="editor-div" class="container-div">
			...
			<div id="instruction-help-overlay" style="top: -285px; position: absolute; right: 0px; color: white; background-color: rgba(0, 0, 0, 0.74); z-index:2; width: 200px; height: 300px; overflow: hidden;">
				<div style="padding:10px">
					<p style="margin-bottom: 5px"><strong>Instrukcje pojedyncze:</strong></p>
					<c:url var="helpUrl" value="/help" />
					<p><a target="_blank" href="${helpUrl}#move" class="cm-keyword">move</a><span class="cost-info"> - 5 <em class="fa fa-bolt"></em></span></p>
					<p><a target="_blank" href="${helpUrl}#jump" class="cm-keyword">jump</a><span class="cost-info"> - 10 <em class="fa fa-bolt"></em></span></p>
					<p><a target="_blank" href="${helpUrl}#left" class="cm-keyword">left</a><span class="cost-info"> - 5 <em class="fa fa-bolt"></em></span></p>
					<p><a target="_blank" href="${helpUrl}#right" class="cm-keyword">right</a><span class="cost-info"> - 5 <em class="fa fa-bolt"></em></span></p>
					...
					<br/>
					<p style="margin-bottom: 5px"><strong>Instrukcje blokowe:</strong></p>
				...
				<div style="width: 100%; text-align: center; bottom: 1px; position: absolute;">
					<div style="cursor: pointer" id="instruction-help-up"><em class="fa fa-chevron-up"></em></div>
					<div style="cursor: pointer" id="instruction-help-down"><em class="fa fa-chevron-down"></em></div>
				</div>
			</div>
		</div>
		<div id="controls-div">
			...
			<button style="width: 40px" id="sound-toggle-button" class="btn btn-primary"><em class="fa fa-volume-up"></em></button>
